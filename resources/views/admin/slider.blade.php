...
@section('judul','Web Setting Slider')
@section('content')
       <div class="main-panel">
            <div class="content">
            	<div class="page-inner">
            		<div class="page-header">
						<h4 class="page-title">Setting Sliders</h4>
					</div>
            	<div class="row">
						<div class="col-md-12">
							<div class="card">
										...
										<table id="add-row" class="display table table-striped table-hover text-center" >
											...
											<tbody>
												...
												<tr>
													...
													<td><img src="{{ asset('images/slider/'.$sl->foto) }}" width="70%"></td>
													<td>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                        <form action="/slider/{{ $sl->id }}" method="post" class="d-inline">
                            @csrf
                            @method('delete')
